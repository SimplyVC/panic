export default {
  channels: {
    ...
    channel_2:
      'Twilio: allows software developers to programmatically '
      + 'make and receive phone calls.',
    channel_3:
      'PagerDuty: a SaaS incident response platform for IT departments.',
    channel_4:
      'OpsGenie: an advanced incident response orchestration platform '
      + 'for DevOps and IT Teams.',
    channel_5:
      'Email: this can either be a private email server or one '
      + 'provided by a company such as Google.',
    how_1:
      'Channels can be setup in the section below, you can configure as '
  ...
  twilio: {
    ...
    account:
      'This is the account SID which can be found on your twilio dashboard.',
    token:
      'This is the authentication token which can be found on your twilio dashboard.',
  ...
  pagerDuty: {
    description:
      'PagerDuty is an incident management platform that provides reliable '
    ...
    token:
      'This is your API token that will be used to send alerts to PagerDuty.',
  ...
  opsGenie: {
    description:
      'Opsgenie is a modern incident management platform for operating '
    ...
    token:
      'This is your API token that will be used to send alerts to OpsGenie.',
    eu:
      'If you are operating OpsGenie in the EU region please have this ticked.',
