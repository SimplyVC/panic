...
class TestEmailAlertsHandler(unittest.TestCase):
    ...
    def tearDown(self) -> None:
        ...
        try:
            self.test_email_alerts_handler.rabbitmq.connect()

            # Declare them before just in case there are tests which do not
            # use these queues and exchanges
            self.test_email_alerts_handler.rabbitmq.queue_declare(
            ...
            self.test_email_alerts_handler.rabbitmq.queue_purge(
            ...
            self.test_email_alerts_handler.rabbitmq.exchange_delete(
                ALERT_EXCHANGE)
            self.test_email_alerts_handler.rabbitmq.disconnect()
    ...
    def test_init_initialises_handler_correctly(self) -> None:
        ...
        self.assertEqual('email_{}_alerts_handler_queue'.format(
            self.test_channel_id),
            self.test_email_alerts_handler._email_alerts_handler_queue)
        self.assertEqual(
