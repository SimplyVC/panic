...
class TestTwilioAlertsHandler(unittest.TestCase):
    ...
    def tearDown(self) -> None:
        ...
        try:
            self.test_twilio_alerts_handler.rabbitmq.connect()

            # Declare them before just in case there are tests which do not
            # use these queues and exchanges
            self.test_twilio_alerts_handler.rabbitmq.queue_declare(
            ...
            self.test_twilio_alerts_handler.rabbitmq.queue_purge(
            ...
            self.test_twilio_alerts_handler.rabbitmq.exchange_delete(
                ALERT_EXCHANGE)
            self.test_twilio_alerts_handler.rabbitmq.disconnect()
