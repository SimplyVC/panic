...
class TestTelegramAlertsHandler(unittest.TestCase):
    ...
    def tearDown(self) -> None:
        ...
        try:
            self.test_telegram_alerts_handler.rabbitmq.connect()
            ...
            self.test_telegram_alerts_handler.rabbitmq.exchange_delete(
                ALERT_EXCHANGE)
            self.test_telegram_alerts_handler.rabbitmq.disconnect()
    ...
    def test_init_initialises_handler_correctly(self) -> None:
        ...
        self.assertEqual('telegram_{}_alerts_handler_queue'.format(
